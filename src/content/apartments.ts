export type Amenity = "Wifi" | "Air Conditioning" | "TV" | "Full Kitchen" | "Coffee Maker" | "Dryer" | "Washer" | "Pet Friendly" | "Outdoor Furniture" | "Hair Dryer" | "Bedding" | "Bidet" | "Kettle" | "Wine Glasses" | "Freezer" | "Ethernet Connection" | "Kitchen" | "Extra Pillows and Blankets" | "Fire Extinguisher" | "Iron" | "Stove" | "Oven" | "Fridge" | "Hangers" | "Private Entrance" | "First Aid Kit" | "Coffee Machine" | "Patio or Balcony" | "Dishes and Cutlery" | "Cleaning Products" | "Carbon Monoxide Detector" | "Heating" | "Body Soap" | "Basic Services" | "Basic Cooking Services" | "Dining Table" | "Baking Tray" | "Outdoor Dining Area" | "Fire Alarm" | "Elevator" | "Bed Linens" | "Baby Crib" | "Coffee" | "Microwave" | "Refrigerator" | "Shower Gel" | "Washing Machine" | "Shampoo" | "Long-term Stays Allowed" | "Dedicated Workspace" | "Clothing Storage" | "Clothes Drying Rack" | "Blackout Curtains";
